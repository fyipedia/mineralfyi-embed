...
Embed [MineralFYI](https://mineralfyi.com) widgets on any website with [mineralfyi-embed](https://widget.mineralfyi.com):

```html
<script src="https://cdn.jsdelivr.net/npm/mineralfyi-embed@1/dist/embed.min.js"></script>
<div data-mineralfyi="entity" data-slug="example"></div>
```

Zero dependencies · Shadow DOM · 4 themes (light/dark/sepia/auto) · [Widget docs](https://widget.mineralfyi.com)
